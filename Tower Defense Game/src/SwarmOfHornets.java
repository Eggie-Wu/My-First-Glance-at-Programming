...
class SwarmOfHornets {
	...
	public boolean removeHornet(Hornet removedhornet) {
		...
		Hornet[] temp = new Hornet[this.size-1];
		
		
		for(int i=0; i< this.size; i++) {
			if(this.swarm[i]==removedhornet) {
	...
	public static class MiniTester {
		...
		private static void honeyBeeTest2() {
			...
			if (bee1.equals(bee2)) {
				System.out.println("assignment1.HoneyBee: equals() doesn't compare two honeybees correctly.");
				containsError = true;
			}
		}
		...
		private static void hornetTest1() {
			...
			if (!hornet.takeAction()) {
				System.out.println("assignment1.Hornet: takeAction() returns the wrong value. Expected: true, actual: false");
				containsError = true;
			}
			if (bee.getHealth() != 4) {
				System.out.println("assignment1.Hornet: takeAction() does the wrong amount of damage to bee. " +
		...
		private static void hornetTest2() {
			...
			Hornet hornet = new Hornet(t, 10, 2);
			if (hornet.takeAction()) {
				System.out.println("assignment1.Hornet: takeAction() returns the wrong value. Expected: false, actual: true");
				containsError = true;
			}
		}
		...
		private static void hornetTest3() {
			...
			if (!h1.equals(h2)) {
				System.out.println("assignment1.Hornet: equals() doesn't compare two hornets correctly. ");
				containsError = true;
			}
		}
		...
		private static void hornetTest4() {
			...
			if (hornet.getHealth() != 10) {
				System.out.println("assignment1.Hornet: Health is initialized to a wrong value. " +
			...
			try {
				...
				if (!damageField) {
					System.out.println("assignment1.Hornet: Damage is initialized to a wrong value. (expected: 2)");
					containsError = true;
				}
		...
		private static void insectTest1() {
			...
			if (!exceptionCaught) {
				System.out.println("assignment1.Insect: Constructor incorrectly deals with the case of " +
		...
		private static void insectTest2() {
			...
			if (insect.getHealth() != 5) {
				System.out.println("assignment1.Insect: getHealth() returns the wrong health. Expected: 5, actual: "+insect.getHealth());
				containsError = true;
			}
		}
		...
		private static void insectTest3() {
			...
			if (t != insect.getPosition()) {
				System.out.println("assignment1.Insect: getPosition() returns the wrong assignment1.Tile.");
				containsError = true;
			}
		}
		...
		private static void insectTest4() {
			...
			if (t2 != insect.getPosition()) {
				System.out.println("assignment1.Insect: setPosition() incorrectly sets the position assignment1.Tile.");
				containsError = true;
			}
		}
		...
		private static void insectTest5() {
			...
			bee.takeDamage(2);
			if (bee.getHealth() != 4) {
				System.out.println("assignment1.Insect: takeDamage() does the wrong amount of damage to itself.");
				containsError = true;
			}
		}
		...
		private static void insectTest6() {
			...
			if (bee1.equals(bee2)) {
				System.out.println("assignment1.Insect: equals() doesn't compare two insects correctly.");
				containsError = true;
			}
		}
		...
		private static void stingyBeeTest1() {
			...
			Hornet hornet = new Hornet(t, 10, 2);
			if (!bee.takeAction()) {
				System.out.println("assignment1.StingyBee: takeAction() returns the wrong value. (expected: true, actual: false)");
				containsError = true;
			}
			if (hornet.getHealth() != 8) {
				System.out.println("assignment1.StingyBee: takeAction() does the wrong amount of damage to hornet. " +
		...
		private static void stingyBeeTest2() {
			...
			StingyBee bee = new StingyBee(t, 2);
			if (bee.takeAction()) {
				System.out.println("assignment1.StingyBee: takeAction() returns the wrong value. Expected: false, actual: true");
				containsError = true;
			}
		}
		...
		private static void stingyBeeTest3() {
			...
			if (bee1.equals(bee2)) {
				System.out.println("assignment1.StingyBee: equals() doesn't compare two stingy bees correctly.");
				containsError = true;
			}
		}
		...
		private static void stingyBeeTest4() {
			...
			StingyBee bee = new StingyBee(t, 2);
			if (bee.getHealth() != 10) {
				System.out.println("assignment1.StingyBee: Health is initialized to a wrong value. " +
						"Expected: 10, actual: "+bee.getHealth());
				containsError = true;
			}
			if (bee.getCost() != 1) {
				System.out.println("assignment1.StingyBee: Food cost is initialized to a wrong value. " +
			...
			try {
				...
				if (!damageField) {
					System.out.println("assignment1.StingyBee: Damage is initialized to a wrong value. (expected: 2)");
					containsError = true;
				}
			} catch(IllegalAccessException e) {
				e.printStackTrace();
		...
		private static void swarmOfHornetsTest6() {
			...
			if (swarm.sizeOfSwarm() != 1 || !Arrays.equals(swarm.getHornets(), expected)) {
				System.out.println("The fields of the assignment1.SwarmOfHornets were not modified correctly.");
				containsError = true;
			}
			if (!b) {
		...
		private static void tankyBeeTest1() {
			...
			if (hornet.getHealth() != 8) {
				System.out.println("assignment1.TankyBee: takeAction() does the wrong amount of damage to hornet. " +
						"Expected: 8, actual: "+hornet.getHealth());
				containsError = true;
			}
		}
		...
		private static void tankyBeeTest2() {
			...
			TankyBee bee = new TankyBee(t, 2, 10);
			if (bee.takeAction()) {
				System.out.println("assignment1.TankyBee: takeAction() returns the wrong value. Expected: false, actual: true");
				containsError = true;
			}
		}
		...
		private static void tankyBeeTest3() {
			...
			bee.takeDamage(2);
			if (bee.getHealth() != 29) {
				System.out.println("assignment1.TankyBee: takeDamage() does the wrong amount of damage to itself. " +
		...
		private static void tankyBeeTest4() {
			...
			if (bee1.equals(bee2)) {
				System.out.println("assignment1.TankyBee: equals() doesn't compare two bees correctly.");
				containsError = true;
			}
		}
		...
		private static void tankyBeeTest5() {
			...
			TankyBee bee = new TankyBee(t, 2, 10);
			if (bee.getHealth() != 30) {
				System.out.println("assignment1.TankyBee: Health is initialized to a wrong value. " +
						"Expected: 30, actual: "+bee.getHealth());
				containsError = true;
			}
			if (bee.getCost() != 3) {
				System.out.println("assignment1.TankyBee: Food cost is initialized to a wrong value. " +
			...
			try {
				...
				if (!damageField) {
					System.out.println("assignment1.TankyBee: Damage is initialized to a wrong value. (expected: 2)");
					containsError = true;
				}
				if (!armorField) {
					System.out.println("assignment1.TankyBee: Armor is initialized to a wrong value. (expected: 10)");
					containsError = true;
				}
			} catch(IllegalAccessException e) {
				e.printStackTrace();
