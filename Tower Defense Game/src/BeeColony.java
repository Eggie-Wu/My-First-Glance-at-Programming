...
class BeeColony extends Frame {
    ...
    private int _timePerFrame = 1000;	// 5 seconds per frame, increase to slow down the game
    ...
    private void createButtons(Panel buttonPanel) {
        ...
        spawnBtn = new Button("Spawn assignment1.Hornet");
